...
import NavCompanySwitcher from '../NavCompanySwitcher';   // ← ADD THIS
...
export const HeaderNav = props => {
  ...
  return (
    <Header 
// @ts-ignore
    isDarkTheme={isDarkTheme} headerNavColor={headerNavColor || navBgColor}>
      <HeaderWrapper 
// @ts-ignore
      isNavTop={isNavTop}>
        <
...
// @ts-ignore
            ...
            {/* ← COMPANY SWITCHER ADDED HERE */}
            <NavCompanySwitcher mode={navMode} 
// @ts-ignore
            configDisplay={true} />
