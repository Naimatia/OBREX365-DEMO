...
export const SideNav = ({navCollapsed, routeInfo, hideGroupTitle, currentTheme, navigationConfig }) => {
  const sideNavTheme = useSelector(state => state.theme.sideNavTheme);
  const props = { sideNavTheme, routeInfo, hideGroupTitle, navigationConfig }
  return (
    <Sider 
      css={css`
